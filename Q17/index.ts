...
console.log(
  "Unfortunately the new dinner table won't arrive in time, so I can invite only two guests to dinner with me"
);
...
guestsList.forEach((lasttwo) =>
  console.log(`Luckily ${lasttwo}, "you are still invited to dinner with me"`)
);
